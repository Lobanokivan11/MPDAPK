...
cd ./output/android
python3 ../../android/build.py $ANDROID_SDK_ROOT $ANDROID_NDK_HOME arm64-v8a --buildtype=debugoptimized -Db_ndebug=true -Did3tag=enabled -Dchromaprint=enabled -Dwrap_mode=forcefallback -Dsqlite=enabled
cd -
cd ./android
