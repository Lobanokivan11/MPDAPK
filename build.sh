...
cd ./output/android
python3 ../../android/build.py $ANDROID_SDK_ROOT $ANDROID_NDK_HOME arm64-v8a --buildtype=release -Db_ndebug=false -Dwrap_mode=forcefallback
cd -
cd ./android
export JAVA_HOME=$JAVA_HOME_17_X64
./gradlew --no-daemon --stacktrace assembleArm64-v8aRelease
mkdir ../../output
cp app/build/outputs/apk/arm64-v8a/release/*.apk ../../output
